...
<?php if(!isset($_GET['edit'])):?>
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" <?php if(!isset($_GET['t'])): echo "class=\"active\""; endif;?> ><a href="<?php echo base_url('adm/pacotes');?>">Todos pacotes</a></li>
                  
                    <li role="presentation" <?php if(isset($_GET['t']) and $_GET['t'] == 'novo'): echo "class=\"active\""; endif;?>><a href="<?php echo base_url('adm/pacotes?t=novo');?>"  >Adicionar pacote</a></li>
                </ul>
                <br>
                                        ...
                                        <div class="col-sm-12">
                                            <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 86px;">Valor</th>

                                                    <th class="" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 64px;">Data da ultima alteração</th>
                                                ...
                                                foreach($fetch as $dds){
                                                    ...
                                                    <tr class="gradeA odd" role="row">
                                                        ...
                                                        <td class="center">
                                                                ...
                                                                <a href="<?php echo base_url('adm/pacotes?edit='.$dds['id']);?>" class="btn btn-info">Editar</a>

                                                            <a href="<?php echo base_url('pages/deleteptc?id='.$dds['id']);?>" class="text-danger btn btn">Excluir</a></td>                                    </tr>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('pages/addPacote');?>">
                                                ...
                                                <div class="form-group">
                                                    <label>Valor</label>
                                                    <input required id="valor2" name="valor_pacote" class="form-control" placeholder="Preço do pacote.">
                                                </div>

                                                    <button type="submit" class="btn btn-default">Adicionar pacote</button>
                                            </form>
                                        </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('pages/updPacote');?>">

                                <input type="hidden" value="<?php echo $result[0]['id']?>" name="pacote">
                                <div class="form-group">
                                    <label>Nome do pacote</label>
                                ...
                                <div class="form-group">
                                    <label>Valor</label>
                                    <input required id="valor2" value="<?php echo $result[0]['valor'];?>" name="valor_pacote" class="form-control" placeholder="Preço do pacote.">
                                </div>
