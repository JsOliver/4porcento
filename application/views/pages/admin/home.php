                        ...
                        <div class="list-group">
                            ...
                            <a href="#" class="list-group-item">
                                ...
                                <span class="pull-right text-muted small"><em>não cadastrado</em>
                                    ...
                                    <span class="pull-right text-muted small" onclick="window.location.href='<?php echo base_url('adm/user?q='.$dds['user']);?>'" style="cursor: pointer;"><em>por usuario <?php echo $dds['user'];?></em>
