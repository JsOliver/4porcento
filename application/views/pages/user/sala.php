            ...
            <div class="row">
                <div class="col-md-4 md-margin-bottom-50">
                    <div class="ms-showcase2-template">
                        ...
                        <div class="master-slider ms-skin-default" id="masterslider">
                            <div class="ms-slide">
                                <img class="ms-brd" src="assets/img/blank.gif" data-src="assets/img/blog/28.jpg"
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-inline shop-product-prices margin-bottom-30">
                        ...
                        <li>
                            <small class="shop-bg-red time-day-left">4 days left</small>
                        </li>
                            ...
                            <img src="http://placehold.it/50/FA6F57/fff&text=EU" alt="User Avatar" class="img-circle"/>
                                                    ...
                                                    <div class="chat-body clearfix">
                                                        <div class="header">
                                                            ...
                                                            <strong class="pull-right primary-font">Bhaumik
                                                                Patel</strong>
                                                        </div>
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
