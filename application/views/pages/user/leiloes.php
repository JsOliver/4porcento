            ...
            <div class="col-md-12">
                <div class="row margin-bottom-5">
                    <div class="col-sm-4 result-category">
                        <h2><small>Leiloes <?php echo $this->Models_model->limitarTexto($tipo,30);?></small></h2>
                        <small class="shop-bg-red badge-results"><?php echo number_format($countnl);?> Resultados</small>
                    </div>
                    <div class="col-sm-8">
                            ...
                            <li class="sort-list-btn">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="leiloes?<?php echo $action;?>=<?php echo strip_tags($tipo);?>&&<?php
                                            if(isset($_GET['limit'])):
                            ...
                            <li class="sort-list-btn">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li><a href="leiloes?<?php echo $action;?>=<?php echo strip_tags($tipo);?>&&limit=20<?php
                                            ...
                                            ?>">20</a></li>
                                        <li><a href="leiloes?<?php echo $action;?>=<?php echo strip_tags($tipo);?>&&limit=10<?php
                                            ...
                                            ?>">10</a></li>
                                        <li><a href="leiloes?<?php echo $action;?>=<?php echo strip_tags($tipo);?>&&limit=5<?php
                                            ...
                                            ?>">5</a></li>
                                        <li><a href="leiloes?<?php echo $action;?>=<?php echo strip_tags($tipo);?>&&limit=3<?php
                        ...
                        <div class="col-md-4">
                            <div class="product-img product-img-brd">
                                ...
                                echo base_url('sala?p='.$dds['id'].'');?>"><?php
                                    ...
                                    ?><img class="full-width img-responsive" src="<?php echo base_url('pages/exibir?id='.$dds['id']);?>" alt="" style="height: 350px;object-fit: cover; object-position: center;"></a>
...
<?php endif;?>
                ...
                <div class="text-center">
                    <ul class="pagination pagination-v2">
                        <li><a href="<?php echo base_url('leiloes?'.$url_atual);?>&&pg=<?php echo $before;?>">Anterior</a></li>

                        <li><a href="<?php echo base_url('leiloes?'.$url_atual);?>&&pg=<?php echo $next;?>">Próximo</a></li>
                    </ul>
                </div><!--/end pagination-->
            </div>
        </div><!--/end row-->
